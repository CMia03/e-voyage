...
export function AdminHeaderWithNotifications() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      ...
      {/* Mobile Menu Sheet - Version simplifiée pour l'exemple */}
          ...
          <div className="flex flex-col h-full">
            ...
            <nav className="flex-1 px-4 py-6 space-y-1">
              ...
              >
                ...
                <ChevronDown
                  className={`h-4 w-4 transition-transform ${expandedSections.includes("destinations") ? "rotate-180" : ""}`}
                />
              </button>
              ...
              {expandedSections.includes("destinations") && (
                <div className="ml-4 space-y-1 border-l-2 border-emerald-200 pl-4 dark:border-emerald-800">
                  <Link
                    href="/admin?section=destinations"
                    className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-foreground transition-colors hover:bg-emerald-50 dark:hover:bg-emerald-950/50"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                  ...
                  <Link
                    href="/admin?section=destinations-create"
                    className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-foreground transition-colors hover:bg-emerald-50 dark:hover:bg-emerald-950/50"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    Ajouter destination
              ...
              {expandedSections.includes("hebergements") && (
                <div className="ml-4 space-y-1 border-l-2 border-emerald-200 pl-4 dark:border-emerald-800">
                  <Link
                    href="/admin?section=hebergements"
                    className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-foreground transition-colors hover:bg-emerald-50 dark:hover:bg-emerald-950/50"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
              ...
              >
                ...
                <ChevronDown
                  className={`h-4 w-4 transition-transform ${expandedSections.includes("notifications-avis") ? "rotate-180" : ""}`}
                />
              </button>
              ...
              {expandedSections.includes("notifications-avis") && (
                <div className="ml-4 space-y-1 border-l-2 border-emerald-200 pl-4 dark:border-emerald-800">
                  ...
                  <Link
                    href="/admin?section=commentaires"
                    className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-foreground transition-colors hover:bg-emerald-50 dark:hover:bg-emerald-950/50"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
              ...
              <Link
                href="/admin?section=planification"
                className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-foreground transition-colors hover:bg-emerald-50 dark:hover:bg-emerald-950/50"
                onClick={() => setIsMobileMenuOpen(false)}
              >
              ...
              {expandedSections.includes("parametrage") && (
                <div className="ml-4 space-y-1 border-l-2 border-emerald-200 pl-4 dark:border-emerald-800">
                  <Link
                    href="/admin?section=entreprise-info"
                    className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-foreground transition-colors hover:bg-emerald-50 dark:hover:bg-emerald-950/50"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
