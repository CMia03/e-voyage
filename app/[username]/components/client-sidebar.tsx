...
export type ClientSection = "home" | "simulation" | "reservations" | "profile";
...
export function ClientSidebar(props: ClientSidebarProps) {
  return (
    <aside className="sticky top-16 hidden h-[calc(100vh-4rem)] w-72 shrink-0 self-start overflow-y-auto border-r border-border/50 bg-card/50 p-5 md:block">
