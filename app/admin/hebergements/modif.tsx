...
type AdminHebergementsModifProps = {
  open: boolean;
  embedded?: boolean;
...
export function AdminHebergementsModif({
  open,
  embedded = false,
  form,
  types,
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Mets a jour les informations de l&apos;hebergement et ajuste sa position sur la carte.
          </p>
        </div>
        {errorAlert}
        {successAlert}
        <Card className="border-border/50">
          <CardHeader>
            ...
            <CardDescription>Modification d&apos;un hebergement</CardDescription>
          </CardHeader>
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[92vh] max-w-5xl overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Modification d&apos;un hebergement</DialogTitle>
          <DialogDescription>
            Modifie les informations et ajuste la position directement sur la carte.
          </DialogDescription>
        </DialogHeader>
        {errorAlert}
        {successAlert}
