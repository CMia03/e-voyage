      ...
      <nav className="space-y-1">
          ...
          >
            ...
            <svg
              className={`h-4 w-4 transition-transform duration-200 ${
                expandedSections.includes("destinations") ? "rotate-180" : ""
              }`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
        ...
        <div className="space-y-1">
          ...
          >
            ...
            <svg
              className={`h-4 w-4 transition-transform duration-200 ${
                expandedSections.includes("hebergements") ? "rotate-180" : ""
              }`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
          ...
          {expandedSections.includes("hebergements") && (
            <div className="ml-4 space-y-1 pl-4 border-l-2 border-emerald-200 dark:border-emerald-800">
              ...
              <button
                type="button"
                onClick={() => console.log("Ajouter un hébergement")}
                className="flex w-full items-center rounded-md px-3 py-2 text-left text-sm text-muted-foreground hover:bg-primary/10"
              >
                <span className="mr-2">•</span>
              ...
              <button
                type="button"
                onClick={() => console.log("Types")}
                className="flex w-full items-center rounded-md px-3 py-2 text-left text-sm text-muted-foreground hover:bg-primary/10"
              >
                <span className="mr-2">•</span>
                Types (Hôtel, Villa, etc.)
              </button>
              <button
                type="button"
                onClick={() => console.log("Équipements")}
                className="flex w-full items-center rounded-md px-3 py-2 text-left text-sm text-muted-foreground hover:bg-primary/10"
              >
                <span className="mr-2">•</span>
                Équipements
        ...
        <div className="space-y-1">
          ...
          >
            ...
            <svg
              className={`h-4 w-4 transition-transform duration-200 ${
                expandedSections.includes("activites") ? "rotate-180" : ""
              }`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
