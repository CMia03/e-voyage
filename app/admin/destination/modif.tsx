...
import { DestinationForm, DestinationFormState } from "./form";

type AdminDestinationModifProps = {
  open: boolean;
  embedded?: boolean;
...
export function AdminDestinationModif({
  open,
  embedded = false,
  form,
  error = "",
      ...
      <div className="space-y-8">
        ...
        <Card className="border-border/50">
          <CardHeader>
            ...
            <CardDescription>Modification d&apos;une destination</CardDescription>
          </CardHeader>
